...
public class LanguageServiceImpl implements LanguageService {
    ...
    public Language updateLanguage(Language language) {
        Optional<Language> languageDb = this.languageRepository.findById(language.getId_languaje());

        if (languageDb.isPresent()){
            Language languageUpdate = languageDb.get();
            languageUpdate.setId_languaje(language.getId_languaje());
            ...
            throw new ResourceNotFoundException("Record not found with id : " + language.getId_languaje());
        }
    }
